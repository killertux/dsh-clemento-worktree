...
try {
  ...
  bundle = join(dirname(manifest), 'lib', 'client.js')
} catch {
  console.log('[dsh-clemento-worktree] @deepseek-ai/dsh-client-ui-conversation not resolvable here — seam not applied')
  process.exit(0)
}
