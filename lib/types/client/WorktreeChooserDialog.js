 ...
 */
export function WorktreeChooserDialog({ useWorkspaceList, useWorktrees, listWorktrees, createWorktree, startSessionIn, onClose, t, }) {
...
export function WorktreeNewSessionButton(props) {
    const [open, setOpen] = useState(false);
    return (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", className: css.button, onClick: () => { setOpen(true); }, children: props.t('button.newSession') }), open && _jsx(WorktreeChooserDialog, { ...props, onClose: () => { setOpen(false); } })] }));
}
